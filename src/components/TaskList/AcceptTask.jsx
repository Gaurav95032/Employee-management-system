...
const AcceptTask = ({ data }) => {
  return (
    <div className="h-[90%] flex-shrink-0 w-[300px] bg-gradient-to-br from-blue-400 to-blue-600 rounded-xl px-6 py-5 shadow-xl transition-all duration-300 hover:scale-105">
      <div className="flex flex-row items-center justify-between mb-3">
        <h2 className="text-sm font-semibold bg-blue-700 rounded-full px-4 py-1 text-white shadow-md">{data.category}</h2>
        <h3 className="text-sm font-medium text-blue-100">{data.taskDate}</h3>
      </div>
      <div className="flex flex-col items-start justify-start h-[90%]">
        ...
        <p className="text-sm font-medium text-blue-100 text-ellipsis overflow-hidden line-clamp-4 mb-4">
